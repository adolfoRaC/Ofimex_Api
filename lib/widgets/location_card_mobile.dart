...
class LocationCardMobile extends StatefulWidget {
  const LocationCardMobile({Key? key}) : super(key: key);

  @override
  State<LocationCardMobile> createState() => _LocationCardMobileState();
}

class _LocationCardMobileState extends State<LocationCardMobile> {
  LatLng? myPosition;
            ...
            children: [
              SizedBox(
                ...
                child: _isLoading
                    ...
                    : _errorMessage != null
                        ? CustomDialog(
                            mensaje: _errorMessage ?? "No hay mensaje",
